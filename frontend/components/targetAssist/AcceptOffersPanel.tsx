...
interface AcceptOffersPanelProps {
    ...
    <tr>
      ...
      <td className="px-4 py-3">
        <input
          ...
          className={`w-40 rounded-md border px-2 py-1.5 text-right ${saved ? "border-emerald-300 bg-emerald-50" : "border-zinc-300"}`}
        />
      </td>
...
export default function AcceptOffersPanel({ totals, existingByTerritoryId, savingTerritoryId, onSave }: AcceptOffersPanelProps) {
  if (totals.length === 0) {
    return (
