...
public interface ISettingsService
{
    ...
    Task<UpdatedScoringWeightsResponse> UpdateScoringWeightsAsync(List<ScoringWeightInputDto> weights, string changedById, string? note, CancellationToken cancellationToken = default);
    ...
    Task<EvaluationSettingDto> UpdateEvaluationSettingAsync(EvaluationSettingUpdateInput input, string updatedById, CancellationToken cancellationToken = default);
}
